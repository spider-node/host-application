...
public class Wrapper<T> implements Serializable {
	 ...
	 * 错误信息：参数不能为空
	 */
	public static final String NOTNULL_ARGUMENT_MESSAGE = "参数不能为空";
	...
	public static <T> Wrapper<T> of(HttpStatus status, String message, T result){
		return new Wrapper<>(status.value(),message,result);
	}
